...
function AboutPage() {
    ...
    const aboutTitleLang = language === "en" ? "About" : "RomanizedMM အကြောင်း";

    const facebookLink = "https://www.facebook.com/people/Romanized-MM/61567473470671/";
...
return (
        <div style={{ color: textColor }}>
            ...
            <main className="aboutBox">
                <LyricsTitleTypography textsize='2rem'>{aboutTitleLang}</LyricsTitleTypography>
